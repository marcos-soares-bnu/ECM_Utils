...
public class ICCcheckOperations extends ICCcheck {
	...
	public ICCcheckOperations(WmiConsole wmi, int mAX_DTDIFF) throws Throwable {
		super(wmi);
		MAX_DTDIFF = mAX_DTDIFF;
	}

	//
	public void checkOperations(String fileOperations) throws Throwable
	{
		String file_prefix		= "dokustarloadmanager";
    	FileWriter writer		= new FileWriter(fileOperations, true);
